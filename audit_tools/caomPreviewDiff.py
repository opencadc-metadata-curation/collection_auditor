...
#    print( f"Number of consistent planes: {len(consistent_planes_df)}" )
    ...
    if len(consistent_instrument_intent_dataProductType_df) > 0:
        ...
        if len(planes_df) > 0 and len(consistent_planes_df) > 0:
        ...
        if len(planes_df) > 0 and len(consistent_instrument_intent_dataProductType_df) > 0:
...
#        print( f"consistent_instrument_intent_dataProductType_df:\n{consistent_instrument_intent_dataProductType_df}" )
        ...
        if len(instrument_intent_dataProductType_df) > 0 and len(consistent_instrument_intent_dataProductType_df) > 0:
